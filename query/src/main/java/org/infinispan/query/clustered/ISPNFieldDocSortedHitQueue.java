...
public class ISPNFieldDocSortedHitQueue extends PriorityQueue {
   ...
   /**
    * Allows redefinition of sort fields if they are <code>null</code>. This is to handle the case
    * using ParallelMultiSearcher where the original list contains AUTO and we don't know the actual
    * sort type until the values come back. The fields can only be set once. This method is thread
    * safe.
    * 
    * @param fields
    */
   ...
   /**
    * Returns an array of collators, possibly <code>null</code>. The collators correspond to any
    * SortFields which were given a specific locale.
    * 
    * @param fields
    ...
    * @param b
    *           ScoreDoc
    * @return <code>true</code> if document <code>a</code> should be sorted after document
    *         <code>b</code>.
    */
   @Override
